...
All implementation work must be guided by the architecture documents in `architecture/`. Before writing any code:
...
- `architecture/overview.md` — system layers, domain model, and key principles
- `architecture/api.md` — API service design, endpoints, and conventions
- `architecture/provider-abstraction.md` — provider interface, resource lifecycle, and implemented providers
- `architecture/ui.md` — Web UI design
- `architecture/sdk.md` — SDK design
- `architecture/cli.md` — CLI design
...
4. Documentation must describe the implemented behavior, not aspirational design — keep `architecture/` for design intent and `docs/` for what actually works today
